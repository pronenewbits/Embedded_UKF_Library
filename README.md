...
This library is made with specific goal for educational purpose (I've made decision to sacrifice speed to get best code readability I could get) while still capable of tackling real-time control system implementation (the code is computed in less than **300 us**! See *Some Benchmark* section below). I strongly sugget you to learn the EKF first before delve deeper into UKF, because many UKF motivation and design lies on analyzing EKF (specifically, on its need for linearization).
